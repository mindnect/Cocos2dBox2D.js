/*
 *    An updated JS port of Box2D
 *    A more up-to-date port of Box2D (and now, LiquidFun!) to JavaScript
 *    Current Release: JSBox2D 2.3.1.r3
 *    https://jsbox2d.googlecode.com
 */

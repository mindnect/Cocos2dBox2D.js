...
var DebugBox2DNode = cc.Node.extend({
    ...
    ctor: function(world) {
        ...
        this._scale = 32 * cc.view.getViewPortRect().width / cc.view.getDesignResolutionSize().width;

        var debugDraw = new CanvasDebugDraw(cc._renderContext);
    ...
    draw: function(ctx) {
        this._super();
        if(this._refWorld) {
            ctx.scale(1, -1);       // vertically revert
